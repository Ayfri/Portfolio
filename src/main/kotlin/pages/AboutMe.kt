...
val sections = listOf(
	...
	Section(
		"""
			At my high-school, for 3 years, I used arduino a lot, only creating big projects on the last year but still. It has let me learn a lot on low-level programming, [C++](https://cplusplus.com) basics and micro-controllers.
			...
			It was interesting to go after some years, back on this project and fix some of the issues and finally understand the code and learn more about OpenGL and low-level graphics processing.
	...
	Section(
		"""
			...
			After some discussions, we accorded to merge our bots together, as we were both passionated by astronomy, we named it [Galileo](https://github.com/Galileo-Bot/galileo).
	...
	Section(
		"""
			...
			Heard about it randomly on an old computer blog that my dad was subscribed to where on an article they spoked about "this new game with an interesting concept".

			I played hundred of hours on Minecraft, created numerous maps, technical maps using CommandBlocks, Datapacks, mods, even created mods since around 2018. In [Java](https://www.java.com) using [Forge](https://files.minecraftforge.net/net/minecraftforge/forge), [Fabric](https://fabricmc.net) since 2020 and in [Kotlin](https://kotlinlang.org) since 2021.

			I know a lot about the the concepts of Minecraft and how they are programmed, this is what motivated me to create a Minecraft-Like game, _4 times_. Approaching more what I want and performances needed for a game like this each time.
